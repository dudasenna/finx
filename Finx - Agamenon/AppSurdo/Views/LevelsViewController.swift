...
class LevelsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        buttonHard.setTitle("Difícil", for: .normal)
        ...
        labelNivel.bottomAnchor.constraint(equalTo: buttonEasy.topAnchor, constant: -70).isActive = true
        ...
        buttonEasy.bottomAnchor.constraint(equalTo: buttonMedium.bottomAnchor, constant: -150).isActive = true
        ...
        buttonHard.topAnchor.constraint(equalTo: buttonMedium.topAnchor, constant: 150).isActive = true
        ...
        okLevelButton.topAnchor.constraint(equalTo: buttonHard.bottomAnchor, constant: 70).isActive = true
